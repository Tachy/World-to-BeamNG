...
BRIDGE_PIER_WIDTH_FRACTION = 0.5  # pier width across the road, as a fraction of the carriageway width
BRIDGE_PIER_DEPTH_FRACTION = 0.5  # pier thickness along the road, as a fraction of the pier width
