...
def _reference_densify(line):
    """Frühere Schleife Segment für Segment - Referenz für den vektorisierten RoadBaseHeight._densify()."""
    points = [line[:1]]
...
def test_densify_is_bit_identical_to_the_segment_loop():
    ...
    for n in (2, 3, 17, 60):
        ...
        line[1] = line[0]  # Segment der Länge 0 -> genau ein Punkt
...
def test_the_kd_tree_is_only_built_on_the_first_query():
    ...
    assert base._tree is None  # ohne Mauern (kein Aufruf) entsteht er nie
